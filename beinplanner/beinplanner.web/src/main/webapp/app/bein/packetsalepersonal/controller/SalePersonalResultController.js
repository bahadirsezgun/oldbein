ptBossApp.controller('SalePersonalResultController', function($rootScope,$scope,$translate,parameterService,$location,homerService,commonService,globals) {
	...
	$scope.saleId;
	$scope.saleShow=true;
	$scope.paymentOrPlaningShow=false;
	...
	$scope.init = function(){
		commonService.pageName=$translate.instant("salePersonalResultPage");
		commonService.pageComment=$translate.instant("salePersonalResultPageComment");
	...
	$scope.planning=function(packetSale){
		...
		$scope.userPacketPaymentOrPlaningPage="./schedule/plan/personal/booking.html";
	...
	$scope.planningUpdate=function(packetSale){
	    ...
	    $scope.saleShow=false;
		$scope.userPacketPaymentOrPlaningPage="./packetsalepersonal/salepersonalupdate.html";
		$scope.paymentPlaningShow=true;
