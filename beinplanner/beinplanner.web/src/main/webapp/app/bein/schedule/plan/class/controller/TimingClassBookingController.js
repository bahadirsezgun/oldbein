ptBossApp.controller('TimingClassBookingController', function($rootScope,$scope,$translate,parameterService,$location,homerService,commonService,globals) {
...
/*
    ...
    */
    ...
    $scope.letsPlanMore=function(){
		...
		var days=generateClassDetailProgram();
  ...
  function generateClassDetailProgram(){
	   var days=new Array();
		if($scope.monday!="0"){
